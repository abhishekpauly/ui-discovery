...
CORE_MODULES = [
    ...
    "ui_discovery.sourcescan", "ui_discovery.sourcemap",
    "ui_discovery.sourcemap.index", "ui_discovery.sourcemap.correlate",
    "ui_discovery.sourcemap.reports",
    ...
    "ui_discovery.narrate", "ui_discovery.pipeline",
    "ui_discovery.qagen",
]
